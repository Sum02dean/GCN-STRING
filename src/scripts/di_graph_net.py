...
class GCN(torch.nn.Module):
    def __init__(self, hidden_channels=64):
        """This class takes in 2 inputs. Each input is a graph representing a single protein structure in a protein pair.
           Each graph is processed to seperate nerual networks, the outputs of which are then concatenated into a single
           hiddden state. Finally this hidden state is passed through a simple dense layer for feature extraction, and then 
           returned for a BCEWithLogitLoss (recommended for binary classificatio) method inside the main training loop.
        ...
        self.g1_conv1 = GCNConv(self.num_node_features, self.hidden_channels)
        ...
        #### Graph 2 ####
        # Layers (consider using class SAGEConv instead)
        self.g2_conv1 = GCNConv(self.num_node_features, self.hidden_channels)
        ...
        # Layers
        self.cat_linear = Linear(self.hidden_channels, self.hidden_channels)
    ...
    def forward(self, x_1, x_2, edge_index_1, edge_index_2, batch_1, batch_2):
        ...
        #### Graph 1 ####
        # Conv block graph 1
        x_1 = self.g1_conv1(x_1, edge_index_1)
        ...
        #### Graph 2 ####
        # Conv block graph 2
        x_2 = self.g2_conv1(x_2, edge_index_2)
